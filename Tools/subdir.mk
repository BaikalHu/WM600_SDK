...
Src_RTOS_exclude_dirs := ${TOPDIR}/Src/OS/LiteOS/arch \
			 ${TOPDIR}/Src/OS/LiteOS/kernel \
			 ${TOPDIR}/Src/OS/LiteOS/OS_CONFIG
#Src_RTOS_dirs := $(shell find ${TOPDIR}/Src/OS/RTOS -maxdepth 1 -type d)
Src_RTOS_dirs := $(shell find ${TOPDIR}/Src/OS/LiteOS -maxdepth 1 -type d)
